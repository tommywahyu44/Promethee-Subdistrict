...
public class AdapterSetKecamatan extends RecyclerView.Adapter<AdapterSetKecamatan.ViewHolder> {
    ...
    public void onBindViewHolder(final AdapterSetKecamatan.ViewHolder holder, final int position) {
        ...
        switch (countKriteria) {
            case 10:  holder.KKT1.setVisibility(View.VISIBLE);  holder.KKT2.setVisibility(View.VISIBLE); holder.KKT1.setText(listItem.getKKT1());  holder.KKT2.setText(listItem.getKKT2());
            case 9:  holder.KK91.setVisibility(View.VISIBLE);  holder.KK92.setVisibility(View.VISIBLE); holder.KK91.setText(listItem.getKK91());  holder.KK92.setText(listItem.getKK92());
            case 8:  holder.KK81.setVisibility(View.VISIBLE);  holder.KK82.setVisibility(View.VISIBLE); holder.KK81.setText(listItem.getKK81());  holder.KK82.setText(listItem.getKK82());
            case 7:  holder.KK71.setVisibility(View.VISIBLE);  holder.KK72.setVisibility(View.VISIBLE); holder.KK71.setText(listItem.getKK71());  holder.KK72.setText(listItem.getKK72());
            case 6:  holder.KK61.setVisibility(View.VISIBLE);  holder.KK62.setVisibility(View.VISIBLE); holder.KK61.setText(listItem.getKK61());  holder.KK62.setText(listItem.getKK62());
            case 5:  holder.KK51.setVisibility(View.VISIBLE);  holder.KK52.setVisibility(View.VISIBLE); holder.KK51.setText(listItem.getKK51());  holder.KK52.setText(listItem.getKK52());
            case 4:  holder.KK41.setVisibility(View.VISIBLE);  holder.KK42.setVisibility(View.VISIBLE); holder.KK41.setText(listItem.getKK41());  holder.KK42.setText(listItem.getKK42());
            case 3:  holder.KK31.setVisibility(View.VISIBLE);  holder.KK32.setVisibility(View.VISIBLE); holder.KK31.setText(listItem.getKK31());  holder.KK32.setText(listItem.getKK32());
            case 2: holder.KK21.setVisibility(View.VISIBLE);  holder.KK22.setVisibility(View.VISIBLE); holder.KK21.setText(listItem.getKK21());  holder.KK22.setText(listItem.getKK22());
            case 1:  holder.KK11.setVisibility(View.VISIBLE);  holder.KK12.setVisibility(View.VISIBLE); holder.KK11.setText(listItem.getKK11());  holder.KK12.setText(listItem.getKK12());
        }
